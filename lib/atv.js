                            ...
                            switch (_context.prev = _context.next) {
                                ...
                                case 2:
                                    ...
                                    return owner.httpClient.request('POST', '/pair-pin-start').then(function () {
                                        ...
                                        return owner.httpClient.request('POST', '/pair-setup-pin', {
                                            ...
                                            pk: bufferUtil.bufferFrom(A, 'hex'),
                                            proof: bufferUtil.bufferFrom(M1, 'hex')
                                        }));
                                    }).then(function () {
                                        ...
                                        return owner.httpClient.request('POST', '/pair-setup-pin', {
                                            ...
                                            epk: bufferUtil.bufferFrom(epk, 'hex'),
                                            authTag: bufferUtil.bufferFrom(authTag, 'hex')
                                        }));
                                    }).then(function () {
                                ...
                                case 14:
                                    ...
                                    return _context.abrupt('return', owner.httpClient.request('POST', '/pair-verify', {
                                        ...
                                        var signature = bufferUtil.bufferFrom(bufferUtil.bufferFrom([0x00, 0x00, 0x00, 0x00]).toString('hex') + ATVAuthenticator.signature(shared, atv_data, signed), 'hex');
